...
const Login = () => {
    ...
    const handlesubmit = async(e)=>{
      ...
      console.log(obj)
      let res = await axios.post('https://blogapp-jtdv.onrender.com/users/login',obj); 
  ...
  <div className="flex bg-yellow-600 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
    ...
    <div className="w-full p-8 lg:w-1/2">
      ...
      <a href="#" className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
        ...
        <h1 className="px-4 py-3 w-5/6 text-center text-gray-700 font-bold">login in with Google</h1>
      </a>
      <div className="mt-4 flex items-center justify-between">
        <span className="border-b w-1/5 lg:w-1/4" />
        <a href="#" className="text-xs text-center text-gray-800 uppercase">or login with email</a>
        <span className="border-b w-1/5 lg:w-1/4" />
      </div>
      <div className="mt-4">
      ...
      <div className="mt-4">
        <div className="flex justify-between">
          ...
          <Link to="/forget-password" className="text-xs text-gray-700">Forget Password?</Link>
        </div>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <Link to="/signup" className="text-xs text-gray-800 uppercase"> Sign up</Link>
        <span className="border-b w-1/5 md:w-1/4" />
      </div>
    </div>
  </div>
